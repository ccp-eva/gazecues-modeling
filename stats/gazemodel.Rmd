...
ggsave("../figures/gazemodel_plot.png", width = 8, height = 5, scale = 1.3, bg = "white")
ggsave("../figures/gazemodel_plot.pdf", width = 8, height = 5, scale = 1.3, bg = "white", device = cairo_pdf) 
