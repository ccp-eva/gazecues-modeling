...
The remote child and teenager sample consisted of `r sum(lifespan_sample$n_total[lifespan_sample$age_group < 18])` children, including `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "3"])` 3-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "3"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "3"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "3"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "3"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "3"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "4"])` 4-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "4"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "4"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "4"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "4"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "4"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "5"])` 5-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "5"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "5"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "5"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "5"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "5"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "6"])` 6-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "6"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "6"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "6"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "6"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "6"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "7"])` 7-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "7"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "7"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "7"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "7"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "7"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "8"])` 8-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "8"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "8"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "8"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "8"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "8"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "9"])` 9-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "9"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "9"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "9"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "9"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "9"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "10"])` 10-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "10"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "10"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "10"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "10"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "10"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "11"])` 11-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "11"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "11"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "11"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "11"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "11"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "12"])` 12-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "12"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "12"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "12"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "12"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "12"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "13"])` 13-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "13"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "13"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "13"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "13"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "13"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "14"])` 14-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "14"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "14"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "14"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "14"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "14"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "15"])` 15-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "15"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "15"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "15"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "15"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "15"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "16"])` 16-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "16"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "16"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "16"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "16"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "16"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "17"])` 17-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "17"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "17"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "17"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "17"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "17"])` girls), `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "18"])` 17-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "18"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "18"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "18"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "18"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "18"])` girls), 
`r sum(lifespan_sample$n_total[lifespan_sample$age_group == "19"])` 17-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "19"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "19"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "19"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "19"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "19"])` girls).
...
Adults were recruited via *Prolific* [@palan2018prolific]. *Prolific* is an online participant recruitment service from the University of Oxford with a predominantly European and US-American subject pool. Participants consisted of `r sum(lifespan_sample$n_total[lifespan_sample$age_group >= 20])` English-speaking adults that reported to have normal or corrected-to-normal vision. The sample included `r sum(lifespan_sample$n_total[lifespan_sample$age_group == "20"])` 20- to 29-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "20"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "20"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "20"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "20"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "20"])` female), 
`r sum(lifespan_sample$n_total[lifespan_sample$age_group == "30"])` 30- to 39-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "30"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "30"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "30"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "30"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "30"])` female),
`r sum(lifespan_sample$n_total[lifespan_sample$age_group == "40"])` 40- to 49-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "40"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "40"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "40"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "40"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "40"])` female),
`r sum(lifespan_sample$n_total[lifespan_sample$age_group == "50"])` 50- to 59-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "50"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "50"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "50"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "50"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "50"])` female),
`r sum(lifespan_sample$n_total[lifespan_sample$age_group == "60"])` 60- to 69-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "60"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "60"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "60"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "60"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "60"])` female), and
`r sum(lifespan_sample$n_total[lifespan_sample$age_group == "70"])` 70- to 79-year-olds (mean = `r sum(lifespan_sample$age_mean[lifespan_sample$age_group == "70"])` years, SD = `r sum(lifespan_sample$age_sd[lifespan_sample$age_group == "70"])`, range = `r sum(lifespan_sample$age_min[lifespan_sample$age_group == "70"])` - `r sum(lifespan_sample$age_max[lifespan_sample$age_group == "70"])`, `r sum(lifespan_sample$n_females[lifespan_sample$age_group == "70"])` female).
